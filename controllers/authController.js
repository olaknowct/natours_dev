...
const createSendToken = (user, statusCode, res) => {
  ...
  const cookieOptions = {
    ...
    // cookie cannot be accessed or modified in anyway by the browser in order to prevent cross site scripting attacks
    httpOnly: true,
  };
  ...
  // Removed the password from response, it will not persist since we didnt not save after.
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  // Select explicitly password sincce its not available when getting
  ...
  user.passwordConfirm = req.body.passwordConfirm;
  await user.save();
  // we cant use this since our method all happens on save action
  // validator from passwordConfirm will not work
